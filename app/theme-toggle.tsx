...
type ThemeToggleVariant = "text" | "icon" | "menu";
...
function ThemeIcon({ targetTheme }: { targetTheme: Theme }) {
...
export function ThemeToggle({
  ...
  const showIcon = variant === "icon" || variant === "menu";
  ...
  return (
    <button
      ...
      title={variant === "icon" ? themeStatusLabel : undefined}
    >
      {showIcon ? <ThemeIcon targetTheme={nextTheme} /> : null}
      {variant !== "icon" ? (
